...
/* Register and load the widget */
	...
	public function __construct() {
		$widget_ops = array(
			...
			'description' => esc_html__( 'The most recent posts on your site.', 'bariplan' ),
			'customize_selective_refresh' => true,
		);
		parent::__construct( 'em_recent_post_widget', esc_html__( 'EM Recent Posts','bariplan' ), $widget_ops );
