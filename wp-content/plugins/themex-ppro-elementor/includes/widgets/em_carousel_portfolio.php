...
/* Register and load the widget */
	...
	public function __construct() {
		$widget_ops = array(
			...
			'description' => esc_html__( 'The most carousel portfolio on your site.', 'bariplan' ),
			'customize_selective_refresh' => true,
		);
		parent::__construct( 'em_carousel_portfolio_widget', esc_html__( 'EM Carousel Portfolio','bariplan' ), $widget_ops );
